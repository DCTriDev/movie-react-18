...
function ItemMovie({data}) {
    return (
        ...
        >
            <img className='w-full h-[265px] object-cover rounded-xl' src={data?.image} alt="image"/>
            <h3 className='text-inherit text-ellipsis whitespace-nowrap mt-3 truncate'>{data?.title}</h3>
        </NavLink>
    );
}
